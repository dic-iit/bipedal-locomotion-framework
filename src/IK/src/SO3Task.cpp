...
bool SO3Task::setVariableHandler(const System::VariablesHandler& variablesHandler)
{
    if (!m_isInitialized)
    {
        log()->error("[SO3Task::setVariableHandler] The task is not initialized. Please call "
                     "initialize method.");
        return false;
    }
    ...
    {
        log()->error("[SO3Task::setVariableHandler] Unable to get the variable named {}.",
    ...
    {
        log()->error("[SO3Task::setVariableHandler] The size of the robot velocity variable is "
