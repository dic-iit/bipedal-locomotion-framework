...
bool SE3Task::setVariableHandler(const System::VariablesHandler& variablesHandler)
{
    if (!m_isInitialized)
    {
        log()->error("[SE3Task::setVariableHandler] The task is not initialized. Please call "
                     "initialize method.");
        return false;
    }
    ...
    {
        log()->error("[SE3Task::setVariableHandler] Unable to get the variable named {}.",
    ...
    {
        log()->error("[SE3Task::setVariableHandler] The size of the robot velocity variable is "
