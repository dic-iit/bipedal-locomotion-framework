...
bool CoMTask::setVariableHandler(const System::VariablesHandler& variablesHandler)
{
    if (!m_isInitialized)
    {
        log()->error("[CoMTask::setVariableHandler] The task is not initialized. Please call "
                     "initialize method.");
        return false;
    }
    ...
    {
        log()->error("[CoMTask::setVariableHandler] The size of the robot velocity variable is "
